...
public class Client extends JFrame implements ActionListener, Runnable
{
    ...
    private void setServer(String ipAddress)
    {
        try
        {
            c = (ChatInterface) Naming.lookup("rmi://" + ipAddress + "/ChatService");
        }
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        else if (ae.getSource() == jButtonSend && !jTextSendMessage.getText().equals(""))
        {
            try
            {
                c.sendMessage(PUBLICMESSAGE, jTextUserName.getText(), jTextSendMessage.getText());
